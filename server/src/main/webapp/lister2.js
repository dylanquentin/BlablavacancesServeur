...
function userStringify(voyages) {
	return voyages.name + "-" + voyages.iduser + "-" + voyages.ville + "-" + voyages.description + "-" + voyages.dateD + "-" + voyages.dateF + "-" + voyages.capacite
}
...
function afficheListUsersTest(data) {
	...
	tabRes.splice(0,tabRes.length);
	tabRes2.splice(0,tabRes.length);
	tabRes3.splice(0,tabRes.length);
	tabResF.splice(0,tabRes.length);
}
